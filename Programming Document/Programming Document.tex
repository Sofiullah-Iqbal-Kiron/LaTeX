...
\columnseprule = 0.5 mm % Column separator rule width, array package hold this commmand.
...
\usepackage
{
 ...
 framed, % Make a frame to CodeListing or any place.
