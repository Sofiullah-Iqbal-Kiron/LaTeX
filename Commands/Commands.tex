...
\section*{Manim}
Manim stands for \textbf{Mathematical Animation}. Created by 3blue1brown. Manim is a custom python library used to animate math explanation. Manim runs on python 3.6 or higher but 3.8 is recommended. \href{https://docs.manim.community/en/stable/}{\textcolor{red}{DOCS here}}.\\
...
\begin{enumerate}
	...
	\item Flags
			  ...
			  \end{enumerate}
	\item \R{\T{self.play(animation(mobject), run\_time = seconds)}}
\end{enumerate}
