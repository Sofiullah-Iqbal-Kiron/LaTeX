...
\personalinfo{
	\email{fajlarabbysr@gmail.com}\smallskip
	\phone{01791298846} \\
	\linkedin{Fajla Rabby}
	\facebook{Fajla Rabby} \\
	\location{Fajlupara, Radhanagar, Badargonj, Rangpur, Bangladesh}
...
\begin{document}
	...
	\begin{paracol}{2}
		...
		\cvevent{RTPCR Program}{| Advanced Bioinformatics, Computational Biology and Data Science Laboratory}{From 15 December, 2021 to 30 December, 2021}{Panthapath, Dhaka, Bangladesh}
		\begin{itemize}
		...
		\cvevent{HSC}{| Rangpur Govt. College}{2014 -- 2016}{Rangpur, Bangladesh}
		\begin{itemize}
			\item GPA: 4.25
		\end{itemize}
		\divider
		
		\cvevent{SSC}{| Lions Schools \& College}{2014}{Sayedpur, Nilphamari, Bangladesh}
		\begin{itemize}
			\item GPA: 5.00
		\end{itemize}
		% ----- EDUCATION -----
