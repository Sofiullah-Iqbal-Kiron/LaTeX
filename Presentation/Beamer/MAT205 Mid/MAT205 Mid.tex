...
% Page transitions-> \transwipe[duration=0.6], \transdissolve, \transblindshorizontal, \transblindsvertical, \transboxin, \transboxin, \transcover, \transdissolve, \transfade, \transfade[duration=0.6], \transglitter, \transglitter, \transreplace and many many more with specificatinos and options.
